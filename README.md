...
# Spinterest — Product Management Case Study
This repository presents the product management documentation for Spinterest, a social music discovery platform created as part of an academic team project. While the engineering work remains in the original source-code repository, this repo focuses on the product direction, research, planning, and cross-functional leadership that shaped the project. 


## Project Overview
Spinterest was designed to solve a clear problem:
Music lovers often struggle to share their curated playlists or discover niche playlists outside their immediate Spotify network. Spinterest creates a space where users can explore collections crafted by others, follow friends, and find music based on shared vibes, genres, and listening habits. 
